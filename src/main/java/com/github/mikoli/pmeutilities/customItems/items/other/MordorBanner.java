...
public class MordorBanner implements ICustomItem, ICustomCrafting {
    @Override
    public String getTag() {
        return "banner_mordor";
    }
    ...
    public ItemStack getItem(int subId) {
        ...
        bannerMeta.addPattern(new Pattern(DyeColor.WHITE, PatternType.GLOBE));
