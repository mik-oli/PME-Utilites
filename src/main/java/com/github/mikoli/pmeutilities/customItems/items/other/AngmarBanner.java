...
public class AngmarBanner implements ICustomItem, ICustomCrafting {
    @Override
    public String getTag() {
        return "banner_angmar";
    }
    ...
    public ItemStack getItem(int subId) {
        ...
        bannerMeta.addPattern(new Pattern(DyeColor.WHITE, PatternType.MOJANG));
