...
public class GondorBanner implements ICustomItem, ICustomCrafting {
    @Override
    public String getTag() {
        return "banner_gondor";
    }
    ...
    public ItemStack getItem(int subId) {
        ...
        bannerMeta.addPattern(new Pattern(DyeColor.WHITE, PatternType.PIGLIN));
